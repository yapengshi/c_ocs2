...
public:
	...
	std::shared_ptr<ControlledSystemBase<2, 1> > clone() const { return std::make_shared<EXP2_Sys1>(*this); }
};
...
public:
	...
	std::shared_ptr<ControlledSystemBase<2, 1> > clone() const { return std::make_shared<EXP2_Sys2>(*this); }
};
...
public:
	...
	std::shared_ptr<DerivativesBase<2,1> > clone() const { return std::make_shared<EXP2_SysDerivative1>(*this); }
};
...
public:
	...
	std::shared_ptr<DerivativesBase<2,1> > clone() const { return std::make_shared<EXP2_SysDerivative2>(*this); }
};
