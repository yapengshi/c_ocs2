...
//		dxdt(1) = -x(1) - u(0)*cos(x(1)) + u(1)*sin(x(0));
	...
	std::shared_ptr<ControlledSystemBase<2, 2> > clone() const { return std::make_shared<EXP3_Sys1>(*this); }
};
...
//		dxdt(1) = -x(0) - u(0)*cos(x(0)) + u(1)*sin(x(1));
	...
	std::shared_ptr<ControlledSystemBase<2, 2> > clone() const { return std::make_shared<EXP3_Sys2>(*this); }
};
...
//		dxdt(1) = x(1) + u(0)*cos(x(1)) - u(1)*sin(x(0));
	...
	std::shared_ptr<ControlledSystemBase<2, 2> > clone() const { return std::make_shared<EXP3_Sys3>(*this); }
};
...
//		B << sin(x_(0)), -cos(x_(1)), -cos(x_(1)), sin(x_(0));
	...
	std::shared_ptr<DerivativesBase<2,2> > clone() const { return std::make_shared<EXP3_SysDerivative1>(*this); }
};
...
//		B << sin(x_(1)), -cos(x_(0)), -cos(x_(0)), sin(x_(1));
	...
	std::shared_ptr<DerivativesBase<2,2> > clone() const { return std::make_shared<EXP3_SysDerivative2>(*this); }
};
...
//		B << -sin(x_(0)), cos(x_(1)), cos(x_(1)), -sin(x_(0));
	...
	std::shared_ptr<DerivativesBase<2,2> > clone() const { return std::make_shared<EXP3_SysDerivative3>(*this); }
};
...
public:
	...
	std::shared_ptr<CostFunctionBase<2,2> > clone() const { return std::make_shared<EXP3_CostFunction1>(*this); };

private:
	double alpha_ = 0.01;
};

class EXP3_CostFunction2 : public EXP3_CostFunction1 {};
class EXP3_CostFunction3 : public EXP3_CostFunction1 {};


/******************************************************************************************************/
/******************************************************************************************************/
/******************************************************************************************************/
//class EXP3_CostFunction2 : public CostFunctionBase<2,2>
//{
//public:
//	EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
//
...
//	void terminalCostStateSecondDerivative(state_matrix_t& dPhidxx)  { dPhidxx.setZero(); }
//
//	std::shared_ptr<CostFunctionBase<2,2> > clone() const { return std::make_shared<EXP3_CostFunction2>(*this); };
//
//private:
//	double alpha_ = 0.01;
//};
...
//class EXP3_CostFunction3 : public CostFunctionBase<2,2>
//{
//public:
//	EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
//
...
//
//	std::shared_ptr<CostFunctionBase<2,2> > clone() const { return std::make_shared<EXP3_CostFunction3>(*this); };
//
//private:
//	double alpha_ = 0.01;
//
