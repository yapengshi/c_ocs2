...
public:
	...
	std::shared_ptr<ControlledSystemBase<6,4> > clone() const { return std::make_shared<EXP4_Sys>(*this); }
};
...
public:
	...
	std::shared_ptr<DerivativesBase<6,4> > clone() const { return std::make_shared<EXP4_SysDerivative>(*this); }
};
